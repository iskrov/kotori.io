        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              {branding.logo.hasIcon && branding.logo.horizontalUrl ? (
                <img src={branding.logo.horizontalUrl} alt={branding.logo.text} className="h-7 w-auto mr-3" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#security" className="text-gray-400 hover:text-white transition-colors">Privacy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#final-cta" className="text-gray-400 hover:text-white transition-colors">Start</a></li>
